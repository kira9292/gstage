...
public class NotificationService {
    ...
    // Envoi de mail avec HTML pour le candidat (sans code de validation)
    public void envoyercandidat(ValidationStatuscandidat validation) throws MessagingException, UnsupportedEncodingException {
        ...
        helper.setSubject("Confirmation de réception de votre demande de stage");
        ...
        String htmlContent = "<html><body style='font-family: Arial, sans-serif; color: #333;'>"
            ...
            + "<p>Nous avons bien reçu votre demande de stage chez Sonatel.</p>"
            + "<p style='font-size: 16px;'>Notre équipe examine actuellement votre dossier. Nous vous tiendrons informé(e) de l'évolution de votre candidature dans les plus brefs délais.</p>"
            + "<p style='font-size: 16px;'>Nous vous remercions pour l'intérêt que vous portez à notre organisation et pour votre confiance.</p>"
            + "<hr style='border: 0; border-top: 1px solid #ddd; margin: 20px 0;'>"
            + "<p style='font-size: 14px;'>Si vous avez des questions, n'hésitez pas à nous contacter à l'adresse : <a href='mailto:stagesupport@sonatel.com'>stagesupport@sonatel.com</a>.</p>"
