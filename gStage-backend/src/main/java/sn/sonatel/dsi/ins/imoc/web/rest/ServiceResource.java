...
/**
 * REST controller for managing {@link sn.sonatel.dsi.ins.imoc.domain.Service}.
 */
@RestController
...
public class ServiceResource {
    ...
    private static final String ENTITY_NAME = "backendService";
    ...
    public ResponseEntity<List<Service>> getAllServices(
        ...
        if ("appuser-is-null".equals(filter)) {
            LOG.debug("REST request to get all Services where appUser is null");
            return new ResponseEntity<>(
                StreamSupport.stream(serviceRepository.findAll().spliterator(), false)
                    .filter(service -> service.getAppUser() == null)
                    .toList(),
                HttpStatus.OK
            );
        }
