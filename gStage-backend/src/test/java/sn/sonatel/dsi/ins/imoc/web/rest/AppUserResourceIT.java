...
class AppUserResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "uk+/b0@ZL]2r.i{_Em-";
    private static final String UPDATED_EMAIL = "ViF@=bbGAG.>-";
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.name(UPDATED_NAME).firstName(UPDATED_FIRST_NAME);
