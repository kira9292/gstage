...
class DepartementTest {
    ...
    void servicesTest() {
        ...
        departement.addServices(appServiceBack);
        assertThat(departement.getServices()).containsOnly(appServiceBack);
        assertThat(appServiceBack.getDepartemen()).isEqualTo(departement);

        departement.removeServices(appServiceBack);
        assertThat(departement.getServices()).doesNotContain(appServiceBack);
        assertThat(appServiceBack.getDepartemen()).isNull();

        departement.services(new HashSet<>(Set.of(appServiceBack)));
        assertThat(departement.getServices()).containsOnly(appServiceBack);
        assertThat(appServiceBack.getDepartemen()).isEqualTo(departement);
