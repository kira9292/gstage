...
public class EtatPaiementAsserts {
    ...
    public static void assertEtatPaiementUpdatableRelationshipsEquals(EtatPaiement expected, EtatPaiement actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getDfc()).as("check dfc").isEqualTo(actual.getDfc()))
            .satisfies(e ->
                assertThat(e.getAssistantGWTECreator()).as("check assistantGWTECreator").isEqualTo(actual.getAssistantGWTECreator())
            );
    }
}
