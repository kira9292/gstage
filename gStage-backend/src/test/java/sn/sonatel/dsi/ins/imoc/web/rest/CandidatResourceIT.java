...
class CandidatResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "rq^@e(.,";
    private static final String UPDATED_EMAIL = "U@X.xrGGFa";

    private static final String DEFAULT_PHONE = "069920093";
    private static final String UPDATED_PHONE = "418840656";
