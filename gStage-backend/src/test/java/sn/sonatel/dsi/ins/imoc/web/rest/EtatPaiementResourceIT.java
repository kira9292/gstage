...
class EtatPaiementResourceIT {
    ...
    private static final String DEFAULT_PAYMENT_PHONE = "490779739";
    private static final String UPDATED_PAYMENT_PHONE = "662381138";
    ...
    void partialUpdateEtatPaiementWithPatch() throws Exception {
        ...
        partialUpdatedEtatPaiement.reference(UPDATED_REFERENCE).paymentDate(UPDATED_PAYMENT_DATE);
