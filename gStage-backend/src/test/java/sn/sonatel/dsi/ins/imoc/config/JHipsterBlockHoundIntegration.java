...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sn.sonatel.dsi.ins.imoc.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sn.sonatel.dsi.ins.imoc.security.DomainUserDetailsService", "createSpringSecurityUser");
